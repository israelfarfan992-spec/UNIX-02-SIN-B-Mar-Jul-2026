...
# PURPOSE: Grade the 'blackhatbash' branch in the UNIX-02-SIN-B repository
# AUTHOR: Andrés (zlkd4rk)
# DATE: 2026
#
# USAGE: ./evaluate_blackhatbash.sh [repo_path] [branch]
...
get_commit_data() {
    ...
    # More robust alternative: use JSON-like formatted output
...
# ============================================================================
# METRIC 2: COMMIT TIMING (7 AM - 5 PM, Ecuador timezone)
# ============================================================================
...
# ============================================================================
# METRIC 3: MESSAGE QUALITY (Descriptive English commit messages)
# ============================================================================
...
calculate_consistency() {
    ...
    if [ "$days_span" -gt 0 ]; then
        ...
        # ADJUSTMENT: Broader, less strict criterion for workload distribution
...
calculate_change_coverage() {
    ...
    # CRITICAL NOTE: Reward atomic, single-file focused changes
...
calculate_commit_size() {
    ...
    # CRITICAL NOTE: Clean micro-commits (~37 lines) now receive excellent score
...
# ============================================================================
# METRIC 7: MERGE COMMIT PRESENCE
# ============================================================================
...
calculate_out_of_hours() {
    ...
    if [ "$total" -gt 0 ]; then
        ...
        # ADJUSTMENT: Flexible tolerance for occasional out-of-office commits
...
calculate_code_integrity() {
    ...
    # CRITICAL NOTE: Reduce penalty for minor fixes or temporary debug markers
    score=$((100 - issues * 1))
...
EOJSON
    ...
    # Inject real dynamic data into JSON
...
EOHTML
    ...
    # Inject real dynamic data into HTML
